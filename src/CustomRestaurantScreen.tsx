...
const CustomRestaurantScreen:FC<{}> = () => {
    const burgerImages:any[] = [
        {id: '1', image: burger, alt: 'burger-image', thumbnail: burgerThb},
        {id: '2', image: burgerKitchen, alt: 'burger-kitchen-image', thumbnail: burgerKitchenThb},
        {id: '3', image: burgerRestaurant, alt: 'burger-restaurant-image', thumbnail: burgerRestaurantThb}
    ];

    const pizzaImages:any[] = [
        {id: '1', image: pizza, alt: 'pizza-image', thumbnail: pizzaThb},
        {id: '2', image: pizzaKitchen, alt: 'pizza-kitchen-image', thumbnail: pizzaKitchenThb},
        {id: '3', image: pizzaRestaurant, alt: 'pizza-restaurant-image', thumbnail: pizzaRestaurantThb}
    ];

    const steakImages:any[] = [
        {id: '1', image: steak, alt: 'steak-image', thumbnail: steakThb},
        {id: '2', image: steakKitchen, alt: 'steak-kitchen-image', thumbnail: steakKitchenThb},
        {id: '3', image: steakRestaurant, alt: 'steak-restaurant-image', thumbnail: steakRestaurantThb}
    ];
